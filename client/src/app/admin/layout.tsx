...
const adminNavItems = [
  ...
  { name: "Mã giảm giá", path: "/admin/coupons", icon: "🎫" },
      ...
      <div className="w-64 bg-gray-900 text-white flex flex-col">
        ...
        <div className="p-6 border-b border-gray-700">
          <Link href="/admin" className="flex items-center">
            <div className="h-8 w-24 bg-blue-600 rounded flex items-center justify-center">
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          <Link href="/" className="mt-3 block text-xs text-gray-400 hover:text-white transition-colors">
            ← Về trang chủ
          </Link>
        </div>
      </div>
